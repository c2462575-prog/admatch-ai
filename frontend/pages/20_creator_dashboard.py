...
with col1:
    if st.button("📝 編輯頻道資料", type="primary", use_container_width=True):
        switch("21_creator_profile.py")
with col2:
    if st.button("🔍 查看匹配品牌", use_container_width=True):
